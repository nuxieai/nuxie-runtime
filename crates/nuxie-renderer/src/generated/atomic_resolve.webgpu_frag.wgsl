...
fn main_1() {
    ...
    if (_e193 <= 1u) {
        phi_3345_ = select(unpack4x8unorm(_e120.y), vec4<f32>(0f, 0f, 0f, 0f), vec4((Yg && (_e193 == 0u))));
    } else {
        let _e201 = (_e117 * 4u);
        ...
        let _e223 = phi_3331_;
        let _e232 = textureSampleLevel(KD, Mb, vec2<f32>(((clamp(_e223, 0f, 1f) * _e215.z) + _e215.w), bitcast<f32>(_e120.y)), 0f);
        phi_3345_ = _e232;
    }
    let _e234 = phi_3345_;
