...
- Weighted/deformed path geometry, remaining parametric path geometry, renderer paint
  allocation, effect path mutation, feather renderer/inner-path behavior, remaining
