...
RENDERER_METAL_ORACLE_ENTRIES ?= --entry native-metal-first-light-rectangle --entry native-metal-first-light-gradient-cubic --entry native-metal-first-light-atlas-feather-stroke
