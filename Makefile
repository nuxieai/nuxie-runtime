...
script-verbs-test: scripted-golden-runner
	"$(SCRIPTED_GOLDEN_RUNNER)" --script-verbs-self-test
	cargo test -p rust-golden-runner --features scripting
