...
@fragment
fn main(@builtin(position) gl_FragCoord: vec4<f32>, @location(1) @interpolate(flat, either) A0_: u32, @location(0) @interpolate(flat, either) i1_: f32) -> @location(0) vec4<f32> {
