...
impl AnimationBase {
    pub const TYPE_KEY: u16 = 27;
    pub const NAME_PROPERTY_KEY: u16 = 55;
    ...
    pub fn copy(&mut self, object: &Self, callbacks: &mut impl AnimationBaseCallbacks) {
    ...
    pub fn deserialize(
        ...
        callbacks: &mut impl AnimationBaseCallbacks,
    ) -> bool {
        match property_key {
