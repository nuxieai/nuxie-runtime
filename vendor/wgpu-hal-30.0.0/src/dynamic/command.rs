...
pub trait DynCommandEncoder: DynResource + core::fmt::Debug {
    ...
    fn can_discard_transition_only_command_buffer(&self) -> bool;
...
impl<C: CommandEncoder + DynResource> DynCommandEncoder for C {
    fn can_coalesce_render_pass_command_buffers(&self) -> bool {
        C::can_coalesce_render_pass_command_buffers(self)
    }

    fn can_discard_transition_only_command_buffer(&self) -> bool {
        C::can_discard_transition_only_command_buffer(self)
    }
