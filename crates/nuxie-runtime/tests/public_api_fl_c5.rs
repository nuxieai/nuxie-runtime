...
fn fl_c5_public_reexports_are_downstream_visible_after_file_split() {
    ...
    exact_public_signature!(StateMachineInstance::scripted_listener_data_context_view_models => fn(&StateMachineInstance, &RuntimeFile, Option<&RuntimeOwnedViewModelHandle>) -> (Option<ScriptViewModel>, Vec<ScriptViewModel>));
