...
class PortManifestCliTest(unittest.TestCase):
    ...
    def test_generate_seeds_the_register_feature_rows(self) -> None:
        expected = {
            ...
            "src/lua/renderer/lua_gpu.cpp": ("partial", "GPUCEIL"),
            "src/joystick.cpp": ("ported", "FL-E4"),
            "src/shapes/list_path.cpp": ("ported", "Phase 3"),
    ...
    def test_generate_seeds_every_cpp_surface_named_by_the_feature_register(self) -> None:
        expected = {
            "src/artboard.cpp": ("ported", "Phase 3"),
            ...
            "src/text/text_input_cursor.cpp": ("ported", "FL-E6"),
            "src/text/text_input_drawable.cpp": ("ported", "FL-E6"),
            "src/text/text_input_selected_text.cpp": ("ported", "FL-E6"),
            "src/text/text_input_selection.cpp": ("ported", "FL-E6"),
            ...
            "src/animation/text_input_listener_group.cpp": ("ported", "FL-E6"),
            ...
            "src/semantic/semantic_data.cpp": ("ported", "FTAIL"),
            "src/semantic/semantic_inference_registry.cpp": ("ported", "SEMRES"),
            "src/semantic/semantic_manager.cpp": ("ported", "FTAIL"),
            "src/semantic/semantic_provider.cpp": ("ported", "FTAIL"),
            "src/lua/lua_audio.cpp": ("ported", "P2F3"),
            "src/lua/lua_buffer_ext.cpp": ("absent", "F7"),
            "src/lua/lua_data_context.cpp": ("ported", "P3-b"),
