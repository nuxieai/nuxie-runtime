...
#ifdef ENABLE_HSL_BLEND_MODES
case He:if(ENABLE_HSL_BLEND_MODES){n0.xyz=clamp(n0.xyz,Q0(.0),Q0(1.));X0=Bb(n0.xyz,q0.xyz,q0.xyz);}break;case Ie:if(ENABLE_HSL_BLEND_MODES){n0.xyz=clamp(n0.xyz,Q0(.0),Q0(1.));X0=Bb(q0.xyz,n0.xyz,q0.xyz);}break;case Je:if(ENABLE_HSL_BLEND_MODES){n0.xyz=clamp(n0.xyz,Q0(.0),Q0(1.));X0=k9(n0.xyz,q0.xyz);}break;case Ke:if(ENABLE_HSL_BLEND_MODES){n0.xyz=clamp(n0.xyz,Q0(.0),Q0(1.));X0=k9(q0.xyz,n0.xyz);}break;
#endif
