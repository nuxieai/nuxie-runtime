...
- Live view-model pointer relink APIs beyond the first default, imported,
  ...
  relink, number source, and boolean source contexts, property-name APIs
  beyond imported view-model pointer sources, owned generated view-model
  pointer paths, and stable public handles that update or expose cached
