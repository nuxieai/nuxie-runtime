...
fn main_1() {
    ...
    var phi_5199_: f32;
    var phi_5890_: u32;
    var phi_5224_: vec4<f32>;
    var phi_1691_: bool;
    var phi_5228_: u32;
    var phi_1700_: bool;
    var phi_5243_: f32;
    var phi_5729_: vec4<f32>;
    var phi_5665_: i32;
    var phi_5886_: vec4<f32>;
    var phi_1275_: bool;
    var phi_5912_: u32;
    var phi_5940_: f32;
    var phi_7319_: f32;
    ...
    var phi_5976_: f32;
    var phi_5977_: f32;
    var phi_7006_: vec4<f32>;
    var phi_6874_: i32;
    var phi_7331_: vec4<f32>;
    var phi_7344_: vec3<f32>;
    var phi_7346_: vec4<f32>;
    ...
    let _e119 = X1_1;
    let _e120 = textureSample(JC, U5_, _e119);
    let _e121 = T4_1;
    ...
    if ((_e144.x & 768u) != 0u) {
        ...
        phi_5194_ = _e148;
        if _e152 {
            phi_5194_ = (1f - abs(((fract((_e148 * 0.5f)) * 2f) + -1f)));
        }
        let _e160 = phi_5194_;
        phi_5193_ = _e160;
    }
    ...
    if (_e217 <= 1u) {
        ...
        let _e252 = phi_5199_;
        let _e261 = textureSampleLevel(MD, Ob, vec2<f32>(((clamp(_e252, 0f, 1f) * _e244.z) + _e244.w), bitcast<f32>(_e144.y)), 0f);
        phi_5890_ = 0u;
        phi_5224_ = _e261;
    }
    let _e263 = phi_5890_;
    ...
    if _e283 {
        ...
        switch bitcast<i32>(_e281) {
            ...
            case 6: {
                ...
                phi_5729_ = vec4<f32>(_e360.x, _e360.y, _e348.z, _e360.w);
                if (_e287.w == 0f) {
                    phi_5729_ = vec4<f32>(_e348.x, _e348.y, _e348.z, 1f);
                }
                let _e370 = phi_5729_;
        ...
        phi_5886_ = vec4<f32>(_e583.x, _e583.y, _e583.z, _e267);
    }
    let _e589 = phi_5886_;
    ...
    if _e635 {
        ...
        switch bitcast<i32>(_e650) {
            ...
            case 6: {
                ...
                phi_7006_ = vec4<f32>(_e722.x, _e722.y, _e710.z, _e722.w);
                if (_e642.w == 0f) {
                    phi_7006_ = vec4<f32>(_e710.x, _e710.y, _e710.z, 1f);
                }
                let _e732 = phi_7006_;
    ...
    switch bitcast<i32>(0u) {
        default: {
            ...
            if (_e1016 != 0f) {
                ...
                phi_7346_ = (_e1013 + (unpack4x8unorm(_e1020) * _e1016));
            }
            let _e1025 = phi_7346_;
    ...
    v4_.c2_[_e118] = 65536u;
    return;
}

@fragment
fn main(@builtin(position) gl_FragCoord: vec4<f32>, @location(0) X1_: vec2<f32>, @location(1) T4_: f32, @location(2) M0_: vec4<f32>, @location(4) @interpolate(flat, either) x3_: u32, @location(5) @interpolate(flat, either) A1_: u32, @location(3) @interpolate(flat, either) H1_: f32) {
