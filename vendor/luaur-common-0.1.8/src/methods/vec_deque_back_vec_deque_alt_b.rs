...
//! Node: `cxx:Method:Luau.Common:Common/include/Luau/VecDeque.h:315:vec_deque_back`
...
//!   - translates_to -> rust_item VecDeque::back

// Dead duplicate skeleton node: the canonical method is implemented elsewhere.
pub fn vec_deque_back() {
    unreachable!("canonical VecDeque::back (and back_mut) lives in crates/luau-common/src/records/vec_deque.rs; this skeleton node is unused");
}
