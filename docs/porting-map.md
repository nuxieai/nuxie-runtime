...
`#12` slices. Public-update and direct target-dirty call counts are covered
separately below.
...
parity remain follow-up `#12` slices. Grouped number call-count paths are
...
Probe-visible C++ `RandomProvider::totalCalls`, grouped target-dirty call
counts, list/non-number paths, imported/owned contexts, secondary dependency
invalidation, real RNG generation/seeding, and full dirty-list scheduler
parity remain follow-up `#12` slices. Grouped public-update call counts are
covered separately below.
...
counts, list/non-number paths, imported/owned contexts, secondary dependency
invalidation, real RNG generation/seeding, and full dirty-list scheduler
parity remain follow-up `#12` slices. Grouped target-dirty call counts are
covered separately below.
...
enum/color/string/trigger target-dirty behavior, secondary dependency
invalidation, and full dirty-list scheduler parity remain follow-up `#12`
slices. Boolean target-to-source and target-dirty behavior are covered
separately below. Source-to-target and target-to-source call counts are
covered separately below.
...
generation, enum/color/string/trigger target-dirty behavior, secondary
...
Probe-visible C++ `RandomProvider::totalCalls`, enum/color/string/trigger
