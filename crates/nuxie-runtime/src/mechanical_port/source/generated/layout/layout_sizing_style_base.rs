use crate::mechanical_port::source::{
    component::Component, core::binary_reader::BinaryReader, sidecar::Sidecar,
};

#[derive(Clone, Default)]
pub struct LayoutSizingStyleMinMaxSizingSidecar {
    pub min_width: f32,
    pub max_width: f32,
    pub min_height: f32,
    pub max_height: f32,
    pub min_width_units_value: u8,
...
pub struct LayoutSizingStyleBase {
    ...
    display_value: u8,
    min_max_sizing: Sidecar<LayoutSizingStyleMinMaxSizingSidecar>,
}
...
impl Default for LayoutSizingStyleBase {
    fn default() -> Self {
        Self {
            ...
            display_value: 0,
            min_max_sizing: Sidecar::default(),
        }
    }
}
...
impl LayoutSizingStyleBase {
    ...
    pub fn min_width(&self) -> f32 {
        self.min_max_sizing
            .get()
            .map_or(0.0, |sidecar| sidecar.min_width)
    }
    ...
    pub fn max_width(&self) -> f32 {
        self.min_max_sizing
            .get()
            .map_or(0.0, |sidecar| sidecar.max_width)
    }
    ...
    pub fn min_height(&self) -> f32 {
        self.min_max_sizing
            .get()
            .map_or(0.0, |sidecar| sidecar.min_height)
    }
    ...
    pub fn max_height(&self) -> f32 {
        self.min_max_sizing
            .get()
            .map_or(0.0, |sidecar| sidecar.max_height)
    }
    ...
    pub fn min_width_units_value(&self) -> u8 {
        self.min_max_sizing
            .get()
            .map_or(0, |sidecar| sidecar.min_width_units_value)
    }
    ...
    pub fn max_width_units_value(&self) -> u8 {
        self.min_max_sizing
            .get()
            .map_or(0, |sidecar| sidecar.max_width_units_value)
    }
    ...
    pub fn min_height_units_value(&self) -> u8 {
        self.min_max_sizing
            .get()
            .map_or(0, |sidecar| sidecar.min_height_units_value)
    }
    ...
    pub fn max_height_units_value(&self) -> u8 {
        self.min_max_sizing
            .get()
            .map_or(0, |sidecar| sidecar.max_height_units_value)
    }
    ...
    pub fn copy(&mut self, object: &Self, callbacks: &mut impl LayoutSizingStyleBaseCallbacks) {
        ...
        self.min_max_sizing = object.min_max_sizing.clone();
