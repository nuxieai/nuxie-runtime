...
fn main_1() {
    ...
    if (_e188 <= 1u) {
        phi_3161_ = select(unpack4x8unorm(_e115.y), vec4<f32>(0f, 0f, 0f, 0f), vec4((eh && (_e188 == 0u))));
    } else {
        let _e196 = (_e112 * 8u);
        ...
        let _e218 = phi_3147_;
        let _e227 = textureSampleLevel(MD, Ob, vec2<f32>(((clamp(_e218, 0f, 1f) * _e210.z) + _e210.w), bitcast<f32>(_e115.y)), 0f);
        phi_3161_ = _e227;
    }
    let _e229 = phi_3161_;
