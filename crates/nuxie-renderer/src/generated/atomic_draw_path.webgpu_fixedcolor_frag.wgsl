...
fn main_1() {
    ...
    var phi_1682_: f32;
    var phi_1718_: u32;
    var phi_1716_: vec4<f32>;
    var phi_1734_: u32;
    var phi_1729_: vec4<f32>;
    var phi_1731_: vec3<f32>;
    ...
    if _e113 {
        ...
        if _e131 {
            ...
            if (abs(_e132.z) < 1000f) {
                ...
                phi_1666_ = (_e141 + (dot(vec4<f32>(_e162.x, _e165.x, _e168.x, _e171.x), exp2(((vec4<f32>(2.5479653f, 2.5479653f, 2.5479653f, 2.5479653f) - _e177) * (_e177 + vec4<f32>(-2.5479653f, -2.5479653f, -2.5479653f, -2.5479653f))))) * _e150));
            }
            let _e186 = phi_1666_;
            phi_1674_ = (_e186 * sign(_e132.x));
        } else {
            let _e191 = O_1[0u];
            let _e193 = O_1[1u];
            phi_1674_ = min(min(_e191, abs(_e193)), 1f);
        }
        let _e198 = phi_1674_;
        phi_1673_ = _e198;
    }
    ...
    if (_e213 == _e205) {
        ...
        phi_1734_ = 0u;
        phi_1729_ = vec4<f32>(0f, 0f, 0f, 0f);
    } else {
        ...
        if ((_e229.x & 768u) != 0u) {
            ...
            phi_1289_ = dh;
            if dh {
                phi_1289_ = ((_e229.x & 512u) != 0u);
            }
            let _e237 = phi_1289_;
            phi_1677_ = _e233;
            if _e237 {
                phi_1677_ = (1f - abs(((fract((_e233 * 0.5f)) * 2f) + -1f)));
            }
            let _e245 = phi_1677_;
            phi_1676_ = _e245;
        }
        ...
        if Zg {
            ...
            if (_e250 != 0u) {
                ...
                if (_e250 == (_e254 >> bitcast<u32>(16i))) {
                    phi_1678_ = min(_e248, unpack2x16float(_e254).x);
                } else {
                    phi_1678_ = 0f;
                }
                let _e262 = phi_1678_;
        ...
        if _e270 {
            ...
            phi_1683_ = min(_e266, clamp((min(_e293.x, _e293.y) + 0.5f), 0f, 1f));
        }
        let _e301 = phi_1683_;
        let _e302 = (_e229.x & 15u);
        if (_e302 <= 1u) {
            let _e307 = (Zg && (_e302 == 0u));
            phi_1719_ = 0u;
            if _e307 {
                phi_1719_ = (_e229.y | pack2x16float(vec2<f32>(_e301, 0f)));
            }
            let _e312 = phi_1719_;
            phi_1718_ = _e312;
            phi_1716_ = select(unpack4x8unorm(_e229.y), vec4<f32>(0f, 0f, 0f, 0f), vec4(_e307));
        } else {
            let _e315 = (_e213 * 4u);
            ...
            if (_e302 == 2u) {
                ...
                phi_1682_ = length(_e332);
            }
            let _e337 = phi_1682_;
            let _e346 = textureSampleLevel(LD, Mb, vec2<f32>(((clamp(_e337, 0f, 1f) * _e329.z) + _e329.w), bitcast<f32>(_e229.y)), 0f);
            phi_1718_ = 0u;
            phi_1716_ = _e346;
        }
        let _e348 = phi_1718_;
        ...
        phi_1734_ = _e348;
        phi_1729_ = vec4<f32>(_e354.x, _e354.y, _e354.z, _e352);
    }
    let _e360 = phi_1734_;
    let _e362 = phi_1729_;
    let _e363 = _e362.xyz;
    ...
    let _e368 = n.A3_;
    if (gh && (_e362.w != 0f)) {
        phi_1731_ = (vec3(((fract((52.982918f * fract(((0.06711056f * _e73.x) + (0.00583715f * _e73.y))))) * _e366) + _e368)) + _e363);
    } else {
        phi_1731_ = _e363;
    }
    let _e384 = phi_1731_;
