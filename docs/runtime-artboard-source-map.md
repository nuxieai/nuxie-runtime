...
| `component.hpp`, `component.cpp` | `component.rs` | component facade, parent validation/link, dirt base, collapse base, and parent hit-test walk | partial: public occurrence facade, retained accessors, exact parent attachment, exact `addDirt`/base collapse, and base `hitTestPoint` extracted; concrete collapse/dirty dispatch and one active type-name accessor remain elsewhere |
