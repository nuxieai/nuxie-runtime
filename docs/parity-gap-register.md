...
| F12 | **Async work pool** (346) + **profiler** (407) | 753 | PARTIAL | P1-m ports the profiler records, lifecycle, wire format, and runtime hooks; its capture backend is the declared D17 adaptation. The async work pool remains absent and matters only if F3 is ported. |
