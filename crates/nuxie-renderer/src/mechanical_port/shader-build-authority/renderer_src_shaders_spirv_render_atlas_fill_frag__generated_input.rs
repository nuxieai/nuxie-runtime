//! Exact generated-input translation of renderer/src/shaders/spirv/render_atlas_fill.frag.
//!
...
pub const PINNED_SOURCE_BYTE_COUNT: usize = 127;
pub const PINNED_SOURCE: &[u8] = include_bytes!("source/renderer_src_shaders_spirv_render_atlas_fill_frag__generated_input.source");
