...
fn main_1() {
    ...
    var phi_3466_: f32;
    var phi_4156_: u32;
    var phi_3490_: vec4<f32>;
    var phi_1593_: bool;
    var phi_3494_: u32;
    var phi_1602_: bool;
    var phi_3509_: f32;
    var phi_3995_: vec4<f32>;
    var phi_3931_: i32;
    var phi_4152_: vec4<f32>;
    var phi_4183_: u32;
    var phi_4177_: vec4<f32>;
    var phi_4178_: vec3<f32>;
    var phi_4180_: vec4<f32>;
    ...
    if (_e117 == _e118) {
        ...
        phi_3456_ = ((_e118 << bitcast<u32>(17u)) + 65536u);
    }
    let _e124 = phi_3456_;
    let _e125 = i1_1;
    q4_.c2_[_e112] = (_e124 + bitcast<u32>(i32(round((_e125 * 2048f)))));
    phi_4183_ = 0u;
    phi_4177_ = vec4<f32>(0f, 0f, 0f, 0f);
    if (_e117 != _e118) {
        ...
        if ((_e138.x & 768u) != 0u) {
            ...
            phi_1437_ = dh;
            if dh {
                phi_1437_ = ((_e138.x & 512u) != 0u);
            }
            let _e146 = phi_1437_;
            phi_3461_ = _e142;
            if _e146 {
                phi_3461_ = (1f - abs(((fract((_e142 * 0.5f)) * 2f) + -1f)));
            }
            let _e154 = phi_3461_;
            phi_3460_ = _e154;
        }
        ...
        if Zg {
            ...
            if (_e159 != 0u) {
                ...
                if (_e159 == (_e163 >> bitcast<u32>(16i))) {
                    phi_3462_ = min(_e157, unpack2x16float(_e163).x);
                } else {
                    phi_3462_ = 0f;
                }
                let _e171 = phi_3462_;
        ...
        if _e179 {
            ...
            phi_3467_ = min(_e175, clamp((min(_e202.x, _e202.y) + 0.5f), 0f, 1f));
        }
        let _e210 = phi_3467_;
        let _e211 = (_e138.x & 15u);
        if (_e211 <= 1u) {
            let _e216 = (Zg && (_e211 == 0u));
            phi_4157_ = 0u;
            if _e216 {
                phi_4157_ = (_e138.y | pack2x16float(vec2<f32>(_e210, 0f)));
            }
            let _e221 = phi_4157_;
            phi_4156_ = _e221;
            phi_3490_ = select(unpack4x8unorm(_e138.y), vec4<f32>(0f, 0f, 0f, 0f), vec4(_e216));
        } else {
            let _e224 = (_e117 * 4u);
            ...
            if (_e211 == 2u) {
                ...
                phi_3466_ = length(_e241);
            }
            let _e246 = phi_3466_;
            let _e255 = textureSampleLevel(LD, Mb, vec2<f32>(((clamp(_e246, 0f, 1f) * _e238.z) + _e238.w), bitcast<f32>(_e138.y)), 0f);
            phi_4156_ = 0u;
            phi_3490_ = _e255;
        }
        let _e257 = phi_4156_;
        ...
        if _e277 {
            ...
            switch bitcast<i32>(_e275) {
                ...
                case 6: {
                    ...
                    phi_3995_ = vec4<f32>(_e354.x, _e354.y, _e342.z, _e354.w);
                    if (_e281.w == 0f) {
                        phi_3995_ = vec4<f32>(_e342.x, _e342.y, _e342.z, 1f);
                    }
                    let _e364 = phi_3995_;
            ...
            phi_4152_ = vec4<f32>(_e577.x, _e577.y, _e577.z, _e261);
        }
        let _e583 = phi_4152_;
        ...
        phi_4183_ = _e257;
        phi_4177_ = vec4<f32>(_e598.x, _e598.y, _e586.z, _e598.w);
    }
    let _e606 = phi_4183_;
    let _e608 = phi_4177_;
    let _e609 = _e608.xyz;
    ...
    let _e614 = n.A3_;
    if (gh && (_e608.w != 0f)) {
        phi_4178_ = (vec3(((fract((52.982918f * fract(((0.06711056f * _e77.x) + (0.00583715f * _e77.y))))) * _e612) + _e614)) + _e609);
    } else {
        phi_4178_ = _e609;
    }
    let _e630 = phi_4178_;
    ...
    switch bitcast<i32>(0u) {
        default: {
            ...
            if (_e651 != 0f) {
                ...
                phi_4180_ = (_e648 + (unpack4x8unorm(_e655) * _e651));
            }
            let _e660 = phi_4180_;
