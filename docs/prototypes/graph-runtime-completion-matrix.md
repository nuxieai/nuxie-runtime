...
- Renderer paint allocation, effect path mutation, feather renderer
  save/translate/clip/draw behavior, effect-path-aware feather rebuilding,
  remaining text/list/scripted `willDraw()` families, and GPU work.
