...
//! Node: `cxx:Method:Luau.Common:Common/include/Luau/SmallVector.h:184:small_vector_back`
...
//!   - translates_to -> rust_item SmallVector::back

// Dead duplicate skeleton node: the canonical method is implemented elsewhere.
pub fn small_vector_back() {
    unreachable!("canonical SmallVector::back lives in crates/luau-common/src/records/small_vector.rs; this skeleton node is unused");
}
