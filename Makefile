...
.PHONY: backend-port-ownership-inventory backend-port-ownership-inventory-check backend-port-dependency-inventory backend-port-dependency-inventory-check
