...
pub trait ViewModelInstanceViewModelBaseCallbacks: crate::mechanical_port::source::generated::viewmodel::viewmodel_instance_value_base::ViewModelInstanceValueBaseCallbacks {
    fn notify_property_changed(&mut self, property_key: u16);
    fn property_value_changed(&mut self) {}
}

pub struct ViewModelInstanceViewModelBase {
    pub base: ViewModelInstanceValue,
    property_value: u32,
}

impl Default for ViewModelInstanceViewModelBase {
    fn default() -> Self {
        Self {
...
impl ViewModelInstanceViewModelBase {
    pub const TYPE_KEY: u16 = 444;
    pub const PROPERTY_VALUE_PROPERTY_KEY: u16 = 577;
    ...
    pub fn set_property_value(
        &mut self,
        value: u32,
        callbacks: &mut impl ViewModelInstanceViewModelBaseCallbacks,
    ) {
        if !self.set_property_value_value(value) {
            return;
        }
        callbacks.property_value_changed();
        ViewModelInstanceViewModelBaseCallbacks::notify_property_changed(
            callbacks,
    ...
    pub fn clone_into(
        ...
        let mut cloned = ViewModelInstanceViewModel::default();
...
impl std::ops::Deref for ViewModelInstanceViewModelBase {
...
impl std::ops::DerefMut for ViewModelInstanceViewModelBase {
