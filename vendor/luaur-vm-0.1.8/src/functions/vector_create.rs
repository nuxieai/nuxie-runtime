...
pub unsafe fn vector_create(
    ...
    if LUA_VECTOR_SIZE == 4 {
        ...
        lua_pushvector_lua_state_f32_f32_f32_f32(
            L,
            x as crate::type_aliases::lua_vector_type::LuaVectorType,
            y as crate::type_aliases::lua_vector_type::LuaVectorType,
            z as crate::type_aliases::lua_vector_type::LuaVectorType,
            w as crate::type_aliases::lua_vector_type::LuaVectorType,
        )?;
    } else {
