                    ...
                    default: {
                        ...
                        if _e54 {
                            ...
                            if (abs(_e47.z) < 1000f) {
                                ...
                                phi_853_ = (_e64 + (dot(vec4<f32>(_e84.x, _e87.x, _e90.x, _e93.x), exp2(((vec4<f32>(2.5479653f, 2.5479653f, 2.5479653f, 2.5479653f) - _e99) * (_e99 + vec4<f32>(-2.5479653f, -2.5479653f, -2.5479653f, -2.5479653f))))) * _e72));
                            }
                            let _e108 = phi_853_;
                            phi_854_ = (_e108 * sign(_e47.x));
                            break;
                        } else {
                            phi_854_ = _e47.x;
                            break;
...
@fragment
fn main(@location(2) O: vec4<f32>, @location(8) l4_: vec2<f32>, @location(7) @interpolate(flat, either) d3_: vec2<u32>, @location(0) X0_: vec4<f32>, @location(3) @interpolate(flat, either) B0_: f32, @location(4) @interpolate(flat, either) U1_: vec2<f32>, @location(5) L0_: vec4<f32>, @location(6) @interpolate(flat, either) e2_: f32) {
    O_1 = O;
    l4_1 = l4_;
    d3_1 = d3_;
    X0_1 = X0_;
