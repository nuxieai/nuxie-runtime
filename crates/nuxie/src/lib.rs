...
pub use nuxie_render_api::{
    ...
    GpuCanvasIndexedDraw, GpuCanvasPassState, GpuCanvasPipelinePlan, GpuCanvasPipelineState,
    GpuCanvasPlan, GpuCanvasRenderPass, GpuCanvasSamplerBinding, GpuCanvasShader,
