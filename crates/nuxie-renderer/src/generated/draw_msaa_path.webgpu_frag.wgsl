...
fn main_1() {
    ...
    if (_e50.w >= 0f) {
        ...
        let _e78 = phi_2806_;
        let _e81 = textureSampleLevel(MD, Pb, vec2<f32>(_e78, -(_e50.w)), 0f);
    ...
    phi_2824_ = _e97;
    if _e101 {
        let _e105 = textureSampleLevel(JC, V5_, _e51.xy, (_e51.z - 1f));
        phi_2817_ = _e105;
        if hh {
            if (_e105.w != 0f) {
    ...
    Qg = vec4<f32>(_e497.x, _e497.y, _e485.z, _e497.w);
    return;
}
