...
impl ImmediateWorker {
    ...
    pub fn append_row_immediate(&mut self, (index, data): (usize, Vec<i16>)) {
        ...
        for i in 0..block_count {
            let x = (i % component.block_size.width as usize) * component.dct_scale_h;
            let y = (i / component.block_size.width as usize) * component.dct_scale_v;
            ...
            dequantize_and_idct_block(
                component.dct_scale_h,
                component.dct_scale_v,
                coefficients,
                quantization_table,
                line_stride,
                output,
        ...
        self.offsets[index] += block_count * component.dct_scale_h * component.dct_scale_v;
    }
