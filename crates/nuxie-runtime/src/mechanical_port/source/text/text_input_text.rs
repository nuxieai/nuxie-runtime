use crate::mechanical_port::source::{
    core::CoreHandle,
    generated::text::text_input_text_base::TextInputTextBase,
    math::mat2d::Mat2D,
    renderer::Renderer,
...
impl TextInputText {
    ...
    pub fn with_path_mut(
        ...
        self.base
            ...
            .with_mut(|parent| {
                ...
                use_path(parent.raw_text_input().text_path());
                true
            })
            .unwrap_or(false)
    }
    pub fn draw(&mut self, renderer: &mut Renderer) {
        self.base.text_input_handle().with_mut(|parent| {
            ...
            let path = Some(parent.raw_text_input().text_path());
            self.base.base.draw_with_path(renderer, path, world);
        });
    }
}
impl std::ops::Deref for TextInputText {
    type Target = TextInputTextBase;
    fn deref(&self) -> &Self::Target {
        &self.base
    }
}
impl std::ops::DerefMut for TextInputText {
