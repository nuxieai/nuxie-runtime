...
//! out of `.riv` binaries with nuxie-binary's public reader and prove luaur
...
use nuxie_scripting::envelope::SignedContent;

/// Scripting corpus files live in the C++ runtime checkout's unit-test
/// assets; located the same way as nuxie-binary's tests (`RIVE_RUNTIME_DIR`
