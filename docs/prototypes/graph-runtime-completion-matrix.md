...
- Renderer paint allocation, broader effect path mutation beyond line-only
  `TrimPath`, feather renderer save/translate/clip/draw behavior,
  effect-path-aware feather rebuilding, remaining text/list/scripted
