...
pub const TRANSLATION_TARGET: &str =
    "crates/nuxie-renderer/src/mechanical_port/source/renderer/src/shaders/tessellate_glsl.rs";
...
pub const PINNED_TESSELLATE_SOURCE: &str = PINNED_TESSELLATE_GLSL_SOURCE;
pub const TESSELLATE_GLSL_SOURCE: &str = PINNED_TESSELLATE_GLSL_SOURCE;
...
pub const CONDITIONAL_BRANCHES: &[ConditionalBranch] = &[
    ...
    ConditionalBranch {
        ...
        active_branch_path: "(defined(@VERTEX)) && (defined(GLSL))",
    },
    ConditionalBranch {
        block_id: "pp-0627",
        branch_ordinal: 2,
...
/// The direct @-prefixed identifiers occurring in tessellate.glsl, retained
/// in first-occurrence source order with their pinned batch-minifier names.
pub const EXPORTED_SYMBOLS: &[ExportedSymbol] = &[
    ...
    ExportedSymbol {
        ...
        source_name: "@a_p0p1_",
        generated_name: "ZC",
        generated_header_name: "GLSL_a_p0p1_",
    },
    ExportedSymbol {
        source_line: 20,
        source_name: "@a_p2p3_",
        generated_name: "AD",
        generated_header_name: "GLSL_a_p2p3_",
    },
    ExportedSymbol {
        source_line: 21,
        source_name: "@a_joinTan_and_ys",
        generated_name: "NC",
        generated_header_name: "GLSL_a_joinTan_and_ys",
    },
    ExportedSymbol {
        source_line: 23,
        source_name: "@a_x0x1",
        generated_name: "VD",
        generated_header_name: "GLSL_a_x0x1",
    },
    ExportedSymbol {
        source_line: 24,
        source_name: "@a_reflectionX0X1",
        generated_name: "WD",
        generated_header_name: "GLSL_a_reflectionX0X1",
    },
    ExportedSymbol {
        source_line: 25,
        source_name: "@a_segmentCounts",
        generated_name: "XD",
        generated_header_name: "GLSL_a_segmentCounts",
    },
    ExportedSymbol {
        source_line: 26,
        source_name: "@a_contourIDWithFlags",
        generated_name: "YD",
        generated_header_name: "GLSL_a_contourIDWithFlags",
    },
    ExportedSymbol {
        source_line: 31,
        source_name: "@a_args",
        generated_name: "RB",
        generated_header_name: "GLSL_a_args",
    },
    ExportedSymbol {
        source_line: 51,
    ...
    ExportedSymbol {
        ...
        generated_name: "PF",
        generated_header_name: "GLSL_tessellateVertexMain",
    },
    ExportedSymbol {
        source_line: 274,
    ...
    ExportedSymbol {
        ...
        generated_name: "QF",
        generated_header_name: "GLSL_tessellateFragmentMain",
    },
];
...
/// The source's only export-header spelling ambiguity is the legacy
/// gaussianIntegralTexture -> featherTexture header alias.
...
/// Macro-defined entrypoints remain literal source spellings and ranges. Their
/// bodies remain in PINNED_TESSELLATE_GLSL_SOURCE rather than becoming Rust.
pub const EXPORTED_FUNCTIONS: &[ShaderFunction] = &[
    ShaderFunction {
        source_line: 61,
        end_line: 284,
        name: "tessellateVertexMain",
        signature: "VERTEX_MAIN(@tessellateVertexMain, Attrs, attrs, _vertexID, _instanceID)",
    ...
    ShaderFunction {
        source_line: 291,
        end_line: 559,
        name: "tessellateFragmentMain",
        signature: "FRAG_DATA_MAIN(TESSDATA4, @tessellateFragmentMain)",
...
pub const CONSUMER_INCLUDE_AUTHORITY: &[ShaderInclude] = &[
    ShaderInclude {
        upstream_file: "renderer/src/metal/render_context_metal_impl.mm",
        include_line: 21,
        directive: "include",
        include_token: "generated/shaders/tessellate.glsl.exports.h",
