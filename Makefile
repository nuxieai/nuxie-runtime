...
RENDERER_METAL_ATOMIC_ORACLE_ENTRIES ?= --entry native-metal-first-light-triangle-generic-atomic --entry native-metal-first-light-gradient-cubic-generic-atomic --entry native-metal-gm-overfill-opaque-generic-atomic --entry native-metal-first-light-nested-clip-generic-atomic --entry native-metal-riv-deterministic-mode-mixed-gradient-generic-atomic
