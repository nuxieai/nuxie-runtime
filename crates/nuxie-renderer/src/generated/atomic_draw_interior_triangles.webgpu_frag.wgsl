...
fn main_1() {
    ...
    var phi_1603_: bool;
    var phi_3510_: f32;
    var phi_3996_: vec4<f32>;
    var phi_3932_: i32;
    var phi_4153_: vec4<f32>;
    var phi_4184_: u32;
    var phi_4178_: vec4<f32>;
    var phi_4179_: vec3<f32>;
    var phi_4181_: vec4<f32>;
    ...
    let _e115 = v4_.c2_[_e112];
    let _e117 = (_e115 >> bitcast<u32>(17u));
    let _e118 = B0_1;
    if (_e117 == _e118) {
        phi_3457_ = _e115;
    } else {
        phi_3457_ = ((_e118 << bitcast<u32>(17u)) + 65536u);
    }
    let _e124 = phi_3457_;
    let _e125 = i1_1;
    v4_.c2_[_e112] = (_e124 + bitcast<u32>(i32(round((_e125 * 2048f)))));
    phi_4184_ = 0u;
    phi_4178_ = vec4<f32>(0f, 0f, 0f, 0f);
    if (_e117 != _e118) {
        let _e135 = ((f32((_e115 & 131071u)) * 0.00048828125f) + -32f);
        let _e138 = BD.c2_[_e117];
        phi_3461_ = _e135;
        if ((_e138.x & 768u) != 0u) {
            let _e142 = abs(_e135);
            phi_1438_ = ih;
            ...
            phi_3462_ = _e142;
            if _e146 {
                phi_3462_ = (1f - abs(((fract((_e142 * 0.5f)) * 2f) + -1f)));
            }
            let _e154 = phi_3462_;
            phi_3461_ = _e154;
        }
        ...
        if (_e211 <= 1u) {
            ...
            let _e246 = phi_3467_;
            let _e255 = textureSampleLevel(MD, Ob, vec2<f32>(((clamp(_e246, 0f, 1f) * _e238.z) + _e238.w), bitcast<f32>(_e138.y)), 0f);
            phi_4157_ = 0u;
            phi_3491_ = _e255;
        }
        let _e257 = phi_4157_;
        ...
        if _e277 {
            ...
            switch bitcast<i32>(_e275) {
                ...
                case 6: {
                    ...
                    phi_3996_ = vec4<f32>(_e354.x, _e354.y, _e342.z, _e354.w);
                    if (_e281.w == 0f) {
                        phi_3996_ = vec4<f32>(_e342.x, _e342.y, _e342.z, 1f);
                    }
                    let _e364 = phi_3996_;
            ...
            phi_4153_ = vec4<f32>(_e577.x, _e577.y, _e577.z, _e261);
        }
        let _e583 = phi_4153_;
        ...
        phi_4184_ = _e257;
        phi_4178_ = vec4<f32>(_e598.x, _e598.y, _e586.z, _e598.w);
    }
    let _e606 = phi_4184_;
    let _e608 = phi_4178_;
    let _e609 = _e608.xyz;
    ...
    switch bitcast<i32>(0u) {
        default: {
            ...
            if (_e651 != 0f) {
                ...
                phi_4181_ = (_e648 + (unpack4x8unorm(_e655) * _e651));
            }
            let _e660 = phi_4181_;
