//! Exact generated-input translation of renderer/src/shaders/spirv/draw_clockwise_atomic_image_mesh.main.
//!
...
pub const PINNED_SOURCE_BYTE_COUNT: usize = 552;
pub const PINNED_SOURCE: &[u8] = include_bytes!("source/renderer_src_shaders_spirv_draw_clockwise_atomic_image_mesh_main__generated_input.source");
