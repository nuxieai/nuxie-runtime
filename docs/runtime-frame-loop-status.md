...
- Phase: E8 evidence publication for immutable main-integrated production
  candidate `e729dd745db1850d0fda60b4631929e40ffbfba7`. E7 evidence landed as
  `e62803df`; independent round-nine reviews W81/W82/W83 rejected unresolved
  guarded tails, fragment-composed identifiers, qualified/module/cross-file
  re-exports, the fungible registry quota, planning checklist state,
  incomplete FL-G03 citations, and stale publication pointers. Round-ten
  corrective `e729dd74` makes every guarded final segment fail closed unless
  it fully resolves to a known non-guarded item, normalizes macro/attribute
  identifier fragments, binds registry rows to exact enclosing-item and
  guarded-name anchors with bidirectional drift rejection, and enables
  candidate checklist enforcement. W84 records runtime 726/726, tools
  differentials 823/823, supplemental `nuxie --lib` 147/147, candidate-mode
  checker tests 77/77, a clean-cache locked detector build, and both golden
  corpora at 317/317 entries plus 647/647 exact segments with zero
  divergences.
  ...
  remain the standing complete-floor reference. The E8 trace is regenerated
  only after the intended evidence set is staged and a porcelain gate confirms
  no unstaged, untracked, Cargo-lock, or other tracked-file churn. The full
  candidate-mode checker is green on that exact fingerprint and runner
  provenance. No post-acceptance rebase remains.
...
1. The independent round-ten reviews (FL-C5 oracle, FL-C5 standards,
   FL-B reacceptance) evaluate this publication against immutable
   candidate `e729dd745db1850d0fda60b4631929e40ffbfba7`.
