...
pub unsafe fn luau_f_vectorlerp(
        ...
        && ttisnumber!(args.offset(1))
    {
        ...
        if LUA_VECTOR_SIZE == 4 {
            setvvalue!(L,
                res,
                luai_lerpf(a.offset(0).read(), b.offset(0).read(), t as crate::type_aliases::lua_vector_type::LuaVectorType),
                luai_lerpf(a.offset(1).read(), b.offset(1).read(), t as crate::type_aliases::lua_vector_type::LuaVectorType),
                luai_lerpf(a.offset(2).read(), b.offset(2).read(), t as crate::type_aliases::lua_vector_type::LuaVectorType),
                luai_lerpf(a.offset(3).read(), b.offset(3).read(), t as crate::type_aliases::lua_vector_type::LuaVectorType)
            );
        } else {
            setvvalue!(L,
                res,
