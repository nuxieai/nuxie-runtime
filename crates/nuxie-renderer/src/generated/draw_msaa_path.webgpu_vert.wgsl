...
fn main_1() {
    ...
    if gh {
        e2_ = f32(((_e439.x >> bitcast<u32>(4i)) & 15u));
    }
    if fh {
        let _e466 = local_1;
        let _e467 = (_e466 * 8u);
        let _e471 = RB.c2_[(_e467 + 2u)];
        let _e482 = RB.c2_[(_e467 + 3u)];
    ...
    if (_e441 == 1u) {
        ...
        if (eh && (_e441 == 0u)) {
            ...
            let _e553 = local_2;
            let _e554 = (_e553 * 8u);
            let _e557 = RB.c2_[_e554];
            let _e568 = RB.c2_[(_e554 + 1u)];
    ...
    if _e597 {
        let _e599 = local_3;
        let _e600 = (_e599 * 8u);
        let _e604 = RB.c2_[(_e600 + 4u)];
        let _e615 = RB.c2_[(_e600 + 5u)];
