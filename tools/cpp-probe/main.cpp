...
#if __has_include("rive/core/field_types/core_uint64_type.hpp")
#define RIVE_PROBE_HAS_LEGACY_UINT64_FIELDS 1
#endif

// Generated by build.sh; building through `make cpp-probe` is required.
#include "build/generated/probe_source_fingerprint.h"
                                   ...
                                   int fieldId)
{
    ...
    switch (fieldId)
    {
        case rive::CoreUintType::id:
            ...
            out << ",\"value\":";
#ifdef RIVE_PROBE_HAS_LEGACY_UINT64_FIELDS
            // Compatibility with the pinned pre-S4 runtime. Candidate
            // b73bc675 removes these serialized scope fields and getUint64.
            switch (propertyKey)
            {
...
#else
            out << rive::CoreRegistry::getUint(mutableObject, propertyKey);
#endif
            break;
