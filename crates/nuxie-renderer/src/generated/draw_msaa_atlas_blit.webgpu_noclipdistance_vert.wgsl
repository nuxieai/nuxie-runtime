...
fn main_1() {
    ...
    if Zg {
        ...
        if (_e68 == 0u) {
            ...
            phi_591_ = unpack2x16float(((_e68 + 1023u) * _e70)).x;
        }
        let _e77 = phi_591_;
        phi_592_ = _e77;
        if _e63 {
    ...
    if (_e62 == 1u) {
        ...
        if bh {
            ...
            phi_593_ = vec4<f32>(_e148.x, _e148.y, _e136.z, _e148.w);
        }
        let _e156 = phi_593_;
        X0_ = _e156;
    } else {
        ...
        if (_e103 || (_e62 == 3u)) {
            ...
            X0_ = vec4<f32>(_e102.x, _e102.y, bitcast<f32>(_e60.y), (-2f - _e99.z));
        }
    }
    let _e158 = n.ff;
    let _e160 = n.gf;
