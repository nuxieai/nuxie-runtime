...
- Weighted/deformed path geometry, remaining parametric path geometry such as
  polygon/star/triangle, renderer paint allocation, effect path mutation,
  feather renderer/inner-path behavior, remaining
