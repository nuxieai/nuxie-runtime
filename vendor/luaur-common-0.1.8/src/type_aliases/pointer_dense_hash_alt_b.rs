...
//! Node: `cxx:TypeAlias:Luau.Common:Common/include/Luau/DenseHash.h:342:pointer`
...
//!   - type_ref <- type_alias pointer (Common/include/Luau/DenseHash.h)
//! - outgoing:
//!   - type_ref -> type_alias pointer (Common/include/Luau/DenseHash.h)
//!   - translates_to -> rust_item pointer
