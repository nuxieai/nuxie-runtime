...
- Raw path geometry payloads, renderer paint allocation, gradient/blend/effect/
  feather paint state, remaining type-specific `willDraw()` families, and GPU
  work.
