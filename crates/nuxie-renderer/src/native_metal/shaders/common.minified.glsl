...
#endif
#ifdef ENABLE_DITHER
e c ga(d L0,c C2,c o3){return ENABLE_DITHER?vc(L0,C2,o3):.0;}e A F2(A j,c c7,d L0,c C2,c o3){return(ENABLE_DITHER&&c7!=.0)?(vc(L0,C2,o3)+j):j;}e A F2(A j,c c7,c xc){return(ENABLE_DITHER&&c7!=.0)?(xc+j):j;}
#else
