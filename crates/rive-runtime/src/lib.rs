...
use state_machine::{
    BlendState1DInstance, BlendStateDirectInstance, RuntimeBlendState1D, RuntimeBlendStateDirect,
    RuntimeScheduledListenerAction, RuntimeStateMachineFireAction, RuntimeTransitionInterpolator,
    StateMachineFireOccurrence, StateMachineViewModelTriggerInstance,
...
pub struct RuntimeImportedViewModelInstanceContext {
    ...
    color_overrides: BTreeMap<Vec<u32>, u32>,
...
impl RuntimeDataBindGraph {
    ...
    fn set_default_view_model_number_source_for_path(&mut self, path: &[u32], value: f32) -> bool {
    ...
    fn refresh_operation_view_model_number_dependents_for_path(
        &mut self,
        path: &[u32],
        value: f32,
    ) -> bool {
    ...
    fn set_owned_view_model_context_symbol_list_index_source_for_data_bind(
        &mut self,
        context: &mut RuntimeOwnedViewModelInstance,
        data_bind_index: usize,
        value: u64,
    ...
    fn set_owned_view_model_context_enum_source_for_data_bind(
        &mut self,
        context: &mut RuntimeOwnedViewModelInstance,
        data_bind_index: usize,
        value: u64,
    ...
    fn set_owned_view_model_context_color_source_for_data_bind(
        &mut self,
        context: &mut RuntimeOwnedViewModelInstance,
        data_bind_index: usize,
        value: u32,
    ...
    fn set_owned_view_model_context_string_source_for_data_bind(
        &mut self,
        context: &mut RuntimeOwnedViewModelInstance,
        data_bind_index: usize,
        value: &[u8],
    ...
    fn set_owned_view_model_context_trigger_source_for_data_bind(
        &mut self,
        context: &mut RuntimeOwnedViewModelInstance,
        data_bind_index: usize,
        value: u64,
    ...
    fn set_default_view_model_string_source_for_path(
        &mut self,
        path: &[u32],
        value: &[u8],
    ) -> bool {
    ...
    fn set_default_view_model_color_source_for_path(&mut self, path: &[u32], value: u32) -> bool {
        let default_context_bound = self.default_view_model_source_context_bound();
        let mut changed = false;
        for source in self.sources.iter_mut().filter(|source| source.path == path) {
    ...
    fn set_default_view_model_enum_source_for_path(&mut self, path: &[u32], value: u64) -> bool {
        let default_context_bound = self.default_view_model_source_context_bound();
        let mut changed = false;
        for source in self.sources.iter_mut().filter(|source| source.path == path) {
    ...
    fn set_default_view_model_symbol_list_index_source_for_path(
        &mut self,
        path: &[u32],
        value: u64,
    ) -> bool {
    ...
    fn set_default_view_model_asset_source_for_path(&mut self, path: &[u32], value: u64) -> bool {
        let default_context_bound = self.default_view_model_source_context_bound();
        let mut changed = false;
        for source in self.sources.iter_mut().filter(|source| source.path == path) {
    ...
    fn set_default_view_model_artboard_source_for_path(
        &mut self,
        path: &[u32],
        value: u64,
    ) -> bool {
    ...
    fn relink_imported_view_model_context_view_model_source_for_data_bind(
        &mut self,
    ...
    fn set_imported_view_model_context_boolean_source_for_data_bind(
        &mut self,
        context: &mut RuntimeImportedViewModelInstanceContext,
        data_bind_index: usize,
        value: bool,
    ...
    fn set_imported_view_model_context_color_source_for_data_bind(
        &mut self,
        context: &mut RuntimeImportedViewModelInstanceContext,
        data_bind_index: usize,
        value: u32,
    ...
    fn set_imported_view_model_context_enum_source_for_data_bind(
        &mut self,
        context: &mut RuntimeImportedViewModelInstanceContext,
        data_bind_index: usize,
        value: u64,
    ...
    fn set_imported_view_model_context_symbol_list_index_source_for_data_bind(
        &mut self,
        context: &mut RuntimeImportedViewModelInstanceContext,
        data_bind_index: usize,
        value: u64,
    ...
    fn set_owned_view_model_context_asset_source_for_data_bind(
        &mut self,
        context: &mut RuntimeOwnedViewModelInstance,
        data_bind_index: usize,
        value: u64,
    ...
    fn set_owned_view_model_context_artboard_source_for_data_bind(
        &mut self,
        context: &mut RuntimeOwnedViewModelInstance,
        data_bind_index: usize,
        value: u64,
    ...
    fn default_view_model_color_source_value_for_data_bind(
        &self,
        data_bind_index: usize,
    ) -> Option<u32> {
        let binding = self
    ...
    fn default_view_model_enum_source_value_for_data_bind(
        &self,
        data_bind_index: usize,
    ) -> Option<u64> {
        let binding = self
    ...
    fn default_view_model_symbol_list_index_source_value_for_data_bind(
        &self,
        data_bind_index: usize,
    ) -> Option<u64> {
        let binding = self
    ...
    fn default_view_model_asset_source_value_for_data_bind(
        &self,
        data_bind_index: usize,
    ) -> Option<u64> {
        let binding = self
    ...
    fn integer_target_global_id_for_data_bind(&self, data_bind_index: usize) -> Option<u32> {
        let target = self
            .default_view_model_bindings
            .iter()
            .find(|binding| binding.data_bind_index == data_bind_index)
    ...
    fn asset_target_global_id_for_data_bind(&self, data_bind_index: usize) -> Option<u32> {
        let target = self
            .default_view_model_bindings
            .iter()
            .find(|binding| binding.data_bind_index == data_bind_index)
    ...
    fn color_target_global_id_for_data_bind(&self, data_bind_index: usize) -> Option<u32> {
        let target = self
            .default_view_model_bindings
            .iter()
            .find(|binding| binding.data_bind_index == data_bind_index)
    ...
    fn enum_target_global_id_for_data_bind(&self, data_bind_index: usize) -> Option<u32> {
        let target = self
            .default_view_model_bindings
            .iter()
            .find(|binding| binding.data_bind_index == data_bind_index)
    ...
    fn apply_default_view_model_symbol_list_index_public_update_targets_to_sources(
        &mut self,
        integers: &[StateMachineBindableIntegerInstance],
    ) -> bool {
        if !self.default_view_model_source_context_bound() {
    ...
    fn apply_default_view_model_enum_public_update_targets_to_sources(
        &mut self,
        enums: &[StateMachineBindableEnumInstance],
    ) -> bool {
        if !self.default_view_model_source_context_bound() {
    ...
    fn apply_default_view_model_asset_public_update_targets_to_sources(
        &mut self,
        assets: &[StateMachineBindableAssetInstance],
    ) -> bool {
        if !self.default_view_model_source_context_bound() {
    ...
    fn apply_default_view_model_artboard_public_update_targets_to_sources(
        &mut self,
        artboards: &[StateMachineBindableArtboardInstance],
    ) -> bool {
        if !self.default_view_model_source_context_bound() {
    ...
    fn apply_default_view_model_view_model_public_update_targets_to_sources(
        &mut self,
        view_models: &[StateMachineBindableViewModelInstance],
    ) -> bool {
        if !self.default_view_model_source_context_bound() {
