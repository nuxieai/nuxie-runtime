...
case "$features" in
    "")
        cp "$repo_dir/crates/nux-capi/exports-v4-portable.txt" "$expected"
        feature_args=""
        ;;
    scripting)
        cp "$repo_dir/crates/nux-capi/exports-v4-portable.txt" "$expected"
    ...
    apple-metal|apple-metal,scripting)
        cat \
            "$repo_dir/crates/nux-capi/exports-v4-portable.txt" \
            "$repo_dir/crates/nux-capi/exports-v4-apple-metal-extension.txt" | \
    ...
    android-vulkan|android-vulkan,scripting)
        cat \
            "$repo_dir/crates/nux-capi/exports-v4-portable.txt" \
            "$repo_dir/crates/nux-capi/exports-v4-android-vulkan-extension.txt" | \
            LC_ALL=C sort -u > "$expected"
        feature_args="--features $features"
        ;;
    android-vulkan,scripting,android-authored-wgsl)
        cat \
            "$repo_dir/crates/nux-capi/exports-v4-portable.txt" \
            "$repo_dir/crates/nux-capi/exports-v4-android-vulkan-extension.txt" \
            "$repo_dir/crates/nux-capi/exports-v4-android-authored-wgsl-extension.txt" | \
            LC_ALL=C sort -u > "$expected"
        feature_args="--features $features"
        ;;
    *)
...
case "$features" in
    ...
    android-vulkan,scripting,android-authored-wgsl)
        ...
        ;;
    *)
        grep -Ev "$apple_extension|$android_extension|$android_authored_wgsl_extension" \
