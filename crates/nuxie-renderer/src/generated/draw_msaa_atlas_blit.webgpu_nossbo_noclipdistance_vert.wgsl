...
fn main_1() {
    ...
    if Zg {
        ...
        if (_e78 == 0u) {
            ...
            phi_633_ = unpack2x16float(((_e78 + 1023u) * _e80)).x;
        }
        let _e87 = phi_633_;
        phi_634_ = _e87;
        if _e73 {
    ...
    if (_e72 == 1u) {
        ...
        if bh {
            ...
            phi_635_ = vec4<f32>(_e166.x, _e166.y, _e154.z, _e166.w);
        }
        let _e174 = phi_635_;
        X0_ = _e174;
    } else {
        ...
        if (_e121 || (_e72 == 3u)) {
            ...
            X0_ = vec4<f32>(_e120.x, _e120.y, bitcast<f32>(_e70.y), (-2f - _e117.z));
        }
    }
    let _e176 = n.ff;
    let _e178 = n.gf;
