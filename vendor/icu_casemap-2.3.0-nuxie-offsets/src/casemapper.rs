...
impl<'a> CaseMapperBorrowed<'a> {
    ...
    /// Nuxie extension: contextual lowercase plus rendered scalar offsets at every
    /// source scalar boundary.
    pub fn lowercase_with_scalar_offsets(
        self,
        src: &str,
        langid: &LanguageIdentifier,
    ) -> (alloc::string::String, alloc::vec::Vec<usize>) {
        self.data
    ...
    /// Nuxie extension: contextual uppercase plus rendered scalar offsets at every
    /// source scalar boundary.
    pub fn uppercase_with_scalar_offsets(
        self,
        src: &str,
        langid: &LanguageIdentifier,
    ) -> (alloc::string::String, alloc::vec::Vec<usize>) {
    ...
    /// Nuxie extension: contextual titlecase_segment plus rendered scalar offsets at every
    /// source scalar boundary. Titlecase treats the segment's first character as
    /// its head, retains tail case, and applies language-specific rules.
    pub fn titlecase_segment_with_scalar_offsets(
        self,
        src: &str,
        langid: &LanguageIdentifier,
    ) -> (alloc::string::String, alloc::vec::Vec<usize>) {
