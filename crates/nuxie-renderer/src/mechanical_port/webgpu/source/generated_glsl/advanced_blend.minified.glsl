...
#ifdef ENABLE_HSL_BLEND_MODES
case Ee:if(ENABLE_HSL_BLEND_MODES){m0.xyz=clamp(m0.xyz,Q0(.0),Q0(1.));X0=zb(m0.xyz,q0.xyz,q0.xyz);}break;case Fe:if(ENABLE_HSL_BLEND_MODES){m0.xyz=clamp(m0.xyz,Q0(.0),Q0(1.));X0=zb(q0.xyz,m0.xyz,q0.xyz);}break;case Ge:if(ENABLE_HSL_BLEND_MODES){m0.xyz=clamp(m0.xyz,Q0(.0),Q0(1.));X0=k9(m0.xyz,q0.xyz);}break;case He:if(ENABLE_HSL_BLEND_MODES){m0.xyz=clamp(m0.xyz,Q0(.0),Q0(1.));X0=k9(q0.xyz,m0.xyz);}break;
#endif
