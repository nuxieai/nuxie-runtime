//! Direct owner for pinned `src/constraints/follow_path_constraint.cpp`.

use super::*;

pub(super) fn follow_path_constrain_components(
...
pub(super) fn target_transform_for_follow_path_constraint_at_distance(
    artboard: &ArtboardInstance,
    constraint: ComponentHandle,
