...
pub trait BindablePropertyIdBaseCallbacks {
    fn notify_property_changed(&mut self, property_key: u16);
    fn property_value_changed(&mut self) {}
}

pub struct BindablePropertyIdBase {
    pub base: BindableProperty,
    property_value: u32,
}

impl Default for BindablePropertyIdBase {
    fn default() -> Self {
        Self {
...
impl BindablePropertyIdBase {
    pub const TYPE_KEY: u16 = 596;
    pub const PROPERTY_VALUE_PROPERTY_KEY: u16 = 823;
