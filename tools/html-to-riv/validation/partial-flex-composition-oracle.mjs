// L09 realistic composition references.
...
const fixtures = JSON.parse(fs.readFileSync(path.join(here, 'partial-flex-compositions.json'), 'utf8'));
const out = path.resolve('output/playwright/html-to-riv/partial-flex-composition-oracle');
