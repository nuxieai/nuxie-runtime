...
fn apply_constraint(
    ...
    match state.kind {
        RuntimeConstraintKind::Distance => {
            apply_distance_constraint(artboard, component_index, constraint, state)
        }
        RuntimeConstraintKind::Translation => {
            apply_translation_constraint(artboard, component_index, constraint, state)
        }
        RuntimeConstraintKind::Rotation => {
            apply_rotation_constraint(artboard, component_index, constraint, state)
        }
        RuntimeConstraintKind::Scale => {
            apply_scale_constraint(artboard, component_index, constraint, state)
        }
        RuntimeConstraintKind::Transform => {
            apply_transform_constraint(artboard, component_index, constraint, state)
        }
        RuntimeConstraintKind::FollowPath | RuntimeConstraintKind::ListFollowPath => {
        ...
        RuntimeConstraintKind::Ik => ik_constraint::apply(artboard, constraint),
        _ => false,
    }
}
