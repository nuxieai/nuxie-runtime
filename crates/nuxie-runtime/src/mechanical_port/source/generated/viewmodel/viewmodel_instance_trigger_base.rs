...
pub struct ViewModelInstanceTriggerBase {
    pub base: ViewModelInstanceValue,
    property_value: u32,
}

impl Default for ViewModelInstanceTriggerBase {
    fn default() -> Self {
        Self {
...
impl ViewModelInstanceTriggerBase {
    pub const TYPE_KEY: u16 = 501;
    pub const PROPERTY_VALUE_PROPERTY_KEY: u16 = 687;
...
impl std::ops::Deref for ViewModelInstanceTriggerBase {
...
impl std::ops::DerefMut for ViewModelInstanceTriggerBase {
