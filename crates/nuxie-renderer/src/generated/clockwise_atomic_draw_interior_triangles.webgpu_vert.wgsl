...
fn main_1() {
    ...
    let _e60 = (_e54 * 4u);
    let _e63 = QB.d2_[_e60];
    let _e64 = bitcast<vec4<f32>>(_e63);
    let _e75 = QB.d2_[(_e60 + 1u)];
    ...
    if (_e97 == 1u) {
        ...
        if (fh && (_e97 == 0u)) {
            ...
            let _e165 = (_e54 * 8u);
            let _e168 = RB.d2_[_e165];
            let _e179 = RB.d2_[(_e165 + 1u)];
    ...
    if _e220 {
        let _e221 = (_e54 * 8u);
        let _e225 = RB.d2_[(_e221 + 4u)];
        let _e236 = RB.d2_[(_e221 + 5u)];
