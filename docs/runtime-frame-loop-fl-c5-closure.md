...
- immutable combined-family production candidate:
  ...
  E7 evidence was published as `e62803df`. Independent round-nine verdicts
  W81/W82/W83 rejected unresolved guarded tails across qualified, module, and
  cross-file re-exports; fragment-composed macro identifiers; the fungible
  file/kind registry quota; planning checklist state; incomplete FL-G03
  citations; and stale publication pointers. Round-ten corrective `e729dd74`
  makes every guarded final segment fail closed unless it fully resolves to a
  known non-guarded item, normalizes macro and attribute identifier fragments,
