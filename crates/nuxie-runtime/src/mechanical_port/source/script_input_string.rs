...
impl ScriptInputString {
    ...
    pub fn init_scripted_value(&mut self) {
        ...
        if let Some(object) = self.script_input.scripted_object() {
            crate::mechanical_port::source::scripted::scripted_object::ScriptedObject::set_primitive_input(
                &object, name,
                crate::mechanical_port::source::scripted::scripted_object::ScriptValue::String(value),
            );
        }
    }
    ...
    pub fn import(&mut self, import_stack: &mut ImportStack) -> StatusCode {
        ...
        importer.add_input(this, ScriptInputStringBase::TYPE_KEY.into());
...
impl std::ops::Deref for ScriptInputString {
    type Target = ScriptInputStringBase;
...
impl std::ops::DerefMut for ScriptInputString {
