...
//! Node: `cxx:Method:Luau.Common:Common/include/Luau/SmallVector.h:148:small_vector_push_back`
...
//!   - translates_to -> rust_item SmallVector::push_back

// Dead duplicate skeleton node: the canonical method is implemented elsewhere.
pub fn small_vector_push_back() {
    unreachable!("canonical SmallVector::push_back lives in crates/luau-common/src/records/small_vector.rs; this skeleton node is unused");
}
