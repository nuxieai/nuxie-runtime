...
fn main_1() {
    ...
    if (_e124 > 0u) {
        let _e131 = FD.c2_[(max(_e124, 1u) - 1u)][2u];
        phi_1774_ = _e131;
    } else {
        phi_1774_ = 0u;
    }
    ...
    let _e464 = phi_1994_;
    z6_ = vec4<f32>(_e60.x, _e60.y, _e383.x, _e383.y);
    A6_ = vec4<f32>(_e381.x, _e381.y, _e63.z, _e63.w);
