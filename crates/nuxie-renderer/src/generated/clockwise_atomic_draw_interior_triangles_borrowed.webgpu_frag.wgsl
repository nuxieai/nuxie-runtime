...
@fragment
fn main(@location(1) @interpolate(flat) i1_: f32, @location(8) l4_: vec2<f32>, @location(7) @interpolate(flat) a3_: vec2<u32>, @location(0) f1_: vec4<f32>, @location(3) @interpolate(flat) A0_: f32, @location(4) @interpolate(flat) U1_: vec2<f32>, @location(5) L0_: vec4<f32>, @location(6) @interpolate(flat) e2_: f32) {
    i1_1 = i1_;
    l4_1 = l4_;
    a3_1 = a3_;
    f1_1 = f1_;
