...
fn main_1() {
    ...
    if (_e439 == 1u) {
        ...
        if (fh && (_e439 == 0u)) {
            ...
            let _e504 = local_1;
            let _e505 = (_e504 * 8u);
            let _e508 = RB.d2_[_e505];
            let _e519 = RB.d2_[(_e505 + 1u)];
    ...
    if _e548 {
        let _e550 = local_2;
        let _e551 = (_e550 * 8u);
        let _e555 = RB.d2_[(_e551 + 4u)];
        let _e566 = RB.d2_[(_e551 + 5u)];
