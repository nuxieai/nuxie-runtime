...
| `constraints/list_follow_path_constraint.hpp`, `constraints/list_follow_path_constraint.cpp` plus generated `list_follow_path_constraint_base.hpp/.cpp` | `constraints/list_follow_path_constraint.rs` | generated leaf keys/callbacks, ConstrainableList registration, and list-item constrain loop | queued next, after the extracted FollowPath base |
