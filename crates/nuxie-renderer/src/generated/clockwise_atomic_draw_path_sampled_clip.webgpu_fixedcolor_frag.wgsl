...
fn main_1() {
    ...
    var phi_2035_: f32;
    var phi_2037_: f32;
    var phi_2042_: vec4<f32>;
    var phi_2040_: f32;
    var phi_2044_: f32;
    var phi_2071_: vec3<f32>;

    let _e65 = f1_1;
    if (_e65.w >= 0f) {
        phi_1968_ = vec4<f32>(_e65.x, _e65.y, _e65.z, _e65.w);
    } else {
        if (_e65.w > -1f) {
            if (_e65.z > 0f) {
                phi_1966_ = _e65.x;
            } else {
                phi_1966_ = length(_e65.xy);
            }
            let _e91 = phi_1966_;
            let _e92 = clamp(_e91, 0f, 1f);
            let _e93 = abs(_e65.z);
            if (_e93 > 1f) {
                phi_1967_ = ((0.9980469f * _e92) + 0.0009765625f);
            } else {
            ...
            phi_1969_ = vec4<f32>(_e79.x, _e79.y, _e79.z, (_e71.w * _e65.z));
        }
        let _e111 = phi_1969_;
        phi_1968_ = _e111;
    }
                ...
                switch bitcast<i32>(0u) {
                    default: {
                        ...
                        if _e191 {
                            ...
                            phi_1987_ = ((1f - _e197.x) - _e202.x);
                            break;
                        } else {
                            phi_1987_ = min(_e120.x, _e120.y);
                            break;
                        }
                    }
                }
                    ...
                    default: {
                        ...
                        if _e127 {
                            ...
                            if (abs(_e120.z) < 1000f) {
                                ...
                                phi_1985_ = (_e137 + (dot(vec4<f32>(_e157.x, _e160.x, _e163.x, _e166.x), exp2(((vec4<f32>(2.5479653f, 2.5479653f, 2.5479653f, 2.5479653f) - _e172) * (_e172 + vec4<f32>(-2.5479653f, -2.5479653f, -2.5479653f, -2.5479653f))))) * _e145));
                            }
                            let _e181 = phi_1985_;
                            phi_1986_ = (_e181 * sign(_e120.x));
                            break;
                        } else {
                            phi_1986_ = _e120.x;
                            break;
        ...
        switch bitcast<i32>(0u) {
            default: {
                ...
                if (_e369 < _e367) {
                    ...
                    phi_2035_ = ((max(_e373, _e268) - _e373) / max((1f - (_e373 * _e119.w)), 0.000062f));
                }
                let _e381 = phi_2035_;
                phi_2037_ = (_e119.w * _e381);
                break;
            }
        }
        let _e384 = phi_2037_;
        phi_2042_ = vec4<f32>(_e119.x, _e119.y, _e119.z, _e384);
    } else {
        switch bitcast<i32>(0u) {
            default: {
                ...
                if (_e279 < _e293) {
                    ...
                    if (_e297 <= _e293) {
                        ...
                        if (_e297 < _e296) {
                            ...
                            phi_2021_ = ((_e268 - _e303) / max((1f - (_e303 * _e119.w)), 0.000062f));
                            phi_2016_ = _e301;
                            phi_2013_ = _e303;
                        }
                        let _e310 = phi_2021_;
                ...
                if (_e326 > 0f) {
                    ...
                    phi_2025_ = (_e322 + ((1f - (_e322 * _e119.w)) * ((clamp((_e333 + _e326), 0f, 1f) - _e335) / max((1f - (_e335 * _e119.w)), 0.000062f))));
                }
                let _e347 = phi_2025_;
                phi_2027_ = (_e119.w * _e347);
                break;
            }
        }
        let _e350 = phi_2027_;
        phi_2042_ = vec4<f32>(_e119.x, _e119.y, _e119.z, _e350);
    }
    let _e391 = phi_2042_;
    phi_2044_ = f32();
    if dh {
