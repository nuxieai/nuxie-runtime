...
@fragment
fn main(@location(0) f1_: vec4<f32>, @builtin(position) gl_FragCoord: vec4<f32>, @location(4) @interpolate(flat) U1_: vec2<f32>, @location(6) @interpolate(flat) e2_: f32) -> @location(0) vec4<f32> {
    f1_1 = f1_;
