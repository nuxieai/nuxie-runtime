...
#endif
#ifdef GB
e ivec2 Nd(){return ivec2(floor(gl_FragCoord));}
#ifdef VD
...
#elif defined(XD)
layout(binding=0,r32i)uniform highp coherent iimage2D Y8;layout(location=0)out i l4;void main(){l4.x=float(imageLoad(Y8,Nd()).x)*(1./Sc);}
#elif defined(VE)
Z2(d3,0,YE);layout(location=0)out i l4;void main(){i P=q1(YE,Nd());l4.x=(P.x-P.y)*ta+(P.z-P.w)*255.;}
#endif
#endif
