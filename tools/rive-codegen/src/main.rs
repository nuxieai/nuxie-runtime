    ...
    fn parse() -> Result<Self> {
        ...
        while let Some(arg) = args.next() {
            match arg.as_str() {
                ...
                "--help" | "-h" => {
                    println!("usage: rive-codegen --defs <defs-dir> --out <schema.rs>");
                    std::process::exit(0);
                }
...
impl Schema {
    ...
    fn render(&self) -> Result<String> {
        ...
        out.push_str("// @generated by `rive-codegen`; do not edit by hand.\n");
        out.push_str("// Source: Rive runtime `dev/defs` JSON.\n\n");
        out.push_str("use crate::{BitmaskPassthrough, Definition, FieldKind, Key, Property};\n\n");
