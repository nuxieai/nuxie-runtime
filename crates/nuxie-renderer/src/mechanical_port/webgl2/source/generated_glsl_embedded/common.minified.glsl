...
#endif
#ifdef MB
e c ga(d L0,c C2,c o3){return MB?wc(L0,C2,o3):.0;}e A F2(A j,c d7,d L0,c C2,c o3){return(MB&&d7!=.0)?(wc(L0,C2,o3)+j):j;}e A F2(A j,c d7,c yc){return(MB&&d7!=.0)?(yc+j):j;}
#else
