...
fn compare_data_context_lookup_value(
    rust_file: &RuntimeFile,
    rust_view_models: &[rive_binary::RuntimeViewModel<'_>],
...
fn compare_data_context_lookup_instance(
    ...
    rust_instance: Option<&rive_binary::RuntimeViewModelInstanceReference<'_>>,
    lookup_index: usize,
    kind: &str,
    label: &str,
) {
...
fn compare_view_model_name_lookups(
    ...
    rust_view_model: &rive_binary::RuntimeViewModel<'_>,
    view_model_index: usize,
    label: &str,
) {
...
fn compare_view_model_instance_values(
    ...
    rust_values: &[rive_binary::RuntimeViewModelInstanceValue<'_>],
    view_model_index: usize,
    instance_index: usize,
    fixture_path: &str,
) {
...
fn assert_view_model_instance_value_property_link(
    rust_file: &RuntimeFile,
    cpp_value: &CppProbeViewModelInstanceValue,
    rust_value: &rive_binary::RuntimeViewModelInstanceValue<'_>,
    label: &str,
) {
...
fn compare_artboard_data_binds(
    ...
    rust_data_binds: &[rive_binary::RuntimeDataBind<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_data_binds.len(),
...
fn compare_artboard_skins(
    ...
    rust_skins: &[rive_binary::RuntimeSkin<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_skins.len(),
...
fn compare_artboard_meshes(
    ...
    rust_meshes: &[rive_binary::RuntimeMesh<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_meshes.len(),
...
fn compare_artboard_paths(
    ...
    rust_paths: &[rive_binary::RuntimePath<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_paths.len(),
...
fn compare_artboard_n_slicer_details(
    ...
    rust_details: &[rive_binary::RuntimeNSlicerDetails<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_details.len(),
...
fn compare_n_slicer_axes(
    ...
    rust_axes: &[rive_binary::RuntimeNSlicerAxis<'_>],
    label: &str,
) {
...
fn compare_n_slicer_tile_modes(
    ...
    rust_tile_modes: &[rive_binary::RuntimeNSlicerTileMode<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_tile_modes.len(),
...
fn compare_artboard_shapes(
    ...
    rust_shapes: &[rive_binary::RuntimeShape<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_shapes.len(),
...
fn compare_artboard_shape_paint_containers(
    ...
    rust_containers: &[rive_binary::RuntimeShapePaintContainer<'_>],
    label: &str,
) {
    assert_eq!(
        cpp_containers.len(),
...
) -> Vec<rive_binary::RuntimeDataConverterGroupItem<'a>> {
    converter
...
fn resolved_number_to_list_view_model<'a>(
    rust_file: &'a RuntimeFile,
    converter: Option<&RuntimeObject>,
) -> Option<rive_binary::RuntimeViewModel<'a>> {
...
fn compare_data_converter_group_items(
    ...
    rust_items: &[rive_binary::RuntimeDataConverterGroupItem<'_>],
    label: &str,
) {
...
fn compare_state_machine_children(
    ...
    rust_children: &rive_binary::RuntimeStateMachine<'_>,
    label: &str,
) {
    assert_eq!(
...
fn compare_keyed_objects(
    ...
    rust_keyed_objects: &[rive_binary::RuntimeKeyedObject<'_>],
    animation_fps: u64,
    label: &str,
) {
    assert_eq!(
...
fn stored_getter_property(
    ...
    if !property.stores_field || property.override_get || property.virtual_ || property.pure_virtual
    {
        ...
        // instead of the stored import member that rive-binary preserves.
        return None;
    }
...
fn primary_property_by_key_in_hierarchy(
    definition: &rive_schema::Definition,
    key: u16,
) -> Option<&'static rive_schema::Property> {
    definition
        .properties
        .iter()
...
fn runtime_file_view_models(file: &RuntimeFile) -> Vec<rive_binary::RuntimeViewModel<'_>> {
    file.view_models()
}

fn runtime_data_enums(file: &RuntimeFile) -> Vec<rive_binary::RuntimeDataEnum<'_>> {
    file.data_enums()
}
...
fn compare_shape_paint_result(
    ...
    rust_paint: &rive_binary::RuntimeShapePaint<'_>,
    paint_index: usize,
    label: &str,
) -> Result<(), String> {
...
fn compare_corpus_state_machine(
    rust_file: &RuntimeFile,
    cpp_state_machine: &CppProbeStateMachine,
    rust_state_machine: &rive_binary::RuntimeStateMachine<'_>,
    artboard_index: usize,
...
fn compare_state_machine_layer_states(
    ...
    rust_layer: &rive_binary::RuntimeStateMachineLayer<'_>,
    label: &str,
) -> Result<(), String> {
...
fn compare_state_machine_fire_actions(
    ...
    rust_fire_actions: &[rive_binary::RuntimeStateMachineFireAction<'_>],
    label: &str,
) -> Result<(), String> {
...
fn compare_listener_actions(
    ...
    rust_actions: &[rive_binary::RuntimeListenerAction<'_>],
    label: &str,
) -> Result<(), String> {
...
fn compare_blend_animation(
    ...
    rust_blend_animation: &rive_binary::RuntimeBlendAnimation<'_>,
...
fn compare_state_transition(
    ...
    rust_transition: &rive_binary::RuntimeStateTransition<'_>,
    rust_file: &RuntimeFile,
