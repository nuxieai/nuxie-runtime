...
const dir=path.resolve(process.env.NUXIE_HTML_REVIEW_DIR??path.join(root,'output/playwright/html-to-riv/underline-dpr'));
...
const skips=focus?['auto']:['auto','all','none'];
...
try {
 for(const skip of skips){
  ...
  const request={html:'<div id="root"><p id="a">カタカナ がぎぐげご ／＿ agypqj</p><p id="b">agypqj gap agypqj gap agypqj gap</p></div>',css:`#root{width:100%;padding:8px;font-family:Fixture}p{font-size:24px;line-height:40px;text-decoration:underline solid red 2px;text-underline-offset:-6px;text-decoration-skip-ink:${skip}}`,width:390,height:200,assets:{font:{kind:'font',family:'Fixture',weight:400,bytes:[...font]}}};
