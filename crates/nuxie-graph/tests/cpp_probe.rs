...
fn graph_projects_rectangle_parametric_path_facts() {
    ...
    assert_eq!(
        ...
        Some(nuxie_graph::ParametricPathNode::Rectangle {
            width: 20.0,
            height: 10.0,
            origin_x: 0.25,
            origin_y: 0.5,
...
fn graph_projects_ellipse_parametric_path_facts() {
    ...
    assert_eq!(
        artboard.paths[0].parametric,
        Some(nuxie_graph::ParametricPathNode::Ellipse {
            width: 30.0,
            height: 12.0,
            origin_x: 0.25,
            origin_y: 0.75,
...
fn graph_projects_polygon_parametric_path_facts() {
    ...
    assert_eq!(
        artboard.paths[0].parametric,
        Some(nuxie_graph::ParametricPathNode::Polygon {
            width: 30.0,
            height: 12.0,
            origin_x: 0.25,
            origin_y: 0.75,
...
fn graph_projects_star_parametric_path_facts() {
    ...
    assert_eq!(
        artboard.paths[0].parametric,
        Some(nuxie_graph::ParametricPathNode::Star {
            width: 30.0,
            height: 12.0,
            origin_x: 0.25,
            origin_y: 0.75,
...
fn graph_projects_triangle_parametric_path_facts() {
    ...
    assert_eq!(
        artboard.paths[0].parametric,
        Some(nuxie_graph::ParametricPathNode::Triangle {
            width: 30.0,
            height: 12.0,
            origin_x: 0.25,
            origin_y: 0.75,
...
fn node_edge(
    ...
    kind: DependencyKind,
) -> nuxie_graph::DependencyNodeEdge {
    nuxie_graph::DependencyNodeEdge {
        source_node,
        dependent_node,
        kind,
...
fn dependency_node_for_component(artboard: &nuxie_graph::ArtboardGraph, local_id: usize) -> usize {
    artboard
        .dependency_nodes
        .iter()
        .find_map(|node| match &node.kind {
            nuxie_graph::DependencyNodeKind::Component {
...
fn dependency_node_for_path_composer(
    artboard: &nuxie_graph::ArtboardGraph,
    shape_local: usize,
) -> usize {
    artboard
        .dependency_nodes
...
fn dependency_node_for_text_variation_helper(
    ...
    artboard
        ...
        .iter()
        .find_map(|node| match &node.kind {
            nuxie_graph::DependencyNodeKind::TextVariationHelper {
...
fn assert_order_before(artboard: &nuxie_graph::ArtboardGraph, source: usize, dependent: usize) {
...
fn compare_artboard_component_lists(
    ...
    rust_artboard: &nuxie_graph::ArtboardGraph,
...
fn compare_artboard_meshes(
    cpp_meshes: &[CppMesh],
    rust_meshes: &[nuxie_graph::MeshGeometryNode],
    artboard_index: usize,
    label: &str,
) {
    assert_eq!(
...
fn compare_artboard_paths(
    cpp_paths: &[CppPath],
    rust_paths: &[nuxie_graph::PathGeometryNode],
    artboard_index: usize,
    label: &str,
) {
    assert_eq!(
...
fn compare_artboard_n_slicer_details(
    ...
    rust_details: &[nuxie_graph::NSlicerDetailsNode],
    artboard_index: usize,
    label: &str,
) {
    assert_eq!(
...
fn compare_n_slicer_axes(
    ...
    rust_axes: &[nuxie_graph::NSlicerAxisNode],
    artboard_index: usize,
    label: &str,
    details_index: usize,
    axis_label: &str,
...
fn compare_n_slicer_tile_modes(
    ...
    rust_tile_modes: &[nuxie_graph::NSlicerTileModeNode],
    artboard_index: usize,
    label: &str,
    details_index: usize,
) {
...
fn compare_artboard_shape_paint_containers(
    ...
    rust_containers: &[nuxie_graph::ShapePaintContainerNode],
    artboard_index: usize,
    label: &str,
) {
    assert_eq!(
